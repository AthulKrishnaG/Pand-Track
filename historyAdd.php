                  ...
                  <form class="form form-horizontal" action="phpcodes-Insert.php" method="post" novalidate>
                    <div class="form-body">
                      ...
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="d_source_patient">Select Patient</label>
                        <div class="col-md-9">
                          <select id="d_source_patient" name="d_source_patient" class="form-control select2" required>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="number" id="h_days_after_the_onset_of_the_disease" name="h_days_after_the_onset_of_the_disease" class="form-control"
