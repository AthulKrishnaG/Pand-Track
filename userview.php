							  ...
							  <tr>
								...
								<form  method='post'>
										...
										<div class='col-sm-12'>
										  ...
										  <button type='submit' id='' name='' formaction='userUpdate.php' class='btn btn-icon btn-sm btn-warning mr-0' ><i class='la la-edit'></i></button>
										  <button type='submit' id='btndocpDel' name='btndocpDel' formaction='phpcodes-Delete.php' onclick='return functionbtnDel()' class='btn btn-icon btn-sm btn-danger mr-0' ><i class='la la-trash'></i></button>
										</div>
									</form> 
